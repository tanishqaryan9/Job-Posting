...
class UserServiceTest {
    ...
    void setUp() {
        ...
        // Build an AppUser whose userProfile is the 'user' above.
        // This satisfies requireOwnership(1L) inside the service.
        ...
        // Inject the principal into the SecurityContext for every test
    ...
    void updateUser_shouldThrow_whenNotFound() {
        ...
        assertThatThrownBy(() -> userService.updateUser(new AddUserRequestDto(), 1L))
                .isInstanceOf(ResourceNotFoundException.class)
    ...
    void updateUserValue_shouldThrow_whenUserNotFound() {
        ...
        assertThatThrownBy(() -> userService.updateUserValue(Map.of("name", "x"), 1L))
                .isInstanceOf(ResourceNotFoundException.class);
    }
    ...
    // ── getUserSkills ─────────────────────────────────────────────────────────
    // getUserSkills has no requireOwnership check — no SecurityContext manipulation needed
    ...
    void addSkillToUser_shouldThrow_whenUserNotFound() {
        ...
        assertThatThrownBy(() -> userService.addSkillToUser(1L, 5L))
                .isInstanceOf(ResourceNotFoundException.class);
    }
