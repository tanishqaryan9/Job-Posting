...
class FeedServiceTest {
    ...
    void getJobsBySalaryRange_shouldReturnJobsInRange() {
        ...
        List<JobDto> result = feedService.getJobsBySalaryRange(70000.0, 95000.0);
    ...
    void getJobsBySalaryRange_shouldReturnOnlyMatchingJobs() {
        ...
        List<JobDto> result = feedService.getJobsBySalaryRange(70000.0, 85000.0);
    ...
    void getJobsBySalaryRange_shouldReturnEmpty_whenNoJobsExist() {
        ...
        List<JobDto> result = feedService.getJobsBySalaryRange(0.0, 100000.0);
    ...
    void getJobsBySalaryRange_shouldReturnEmpty_whenRangeDoesNotMatch() {
        ...
        List<JobDto> result = feedService.getJobsBySalaryRange(200000.0, 300000.0);
    ...
    void getJobsBySkillMatch_shouldReturnJobsWithMatchingSkills() {
        ...
        // Only job1 matches (user has Java, job1 requires Java)
        assertThat(result).hasSize(1);
    ...
    @Test
    void getJobsBySkillMatch_shouldReturnEmpty_whenNoSkillsMatch() {
        user.setSkills(new HashSet<>()); // user has no skills
        when(userRepository.findById(1L)).thenReturn(Optional.of(user));
        when(jobRepository.findAll()).thenReturn(List.of(job1, job2));
        when(modelMapper.map(any(Job.class), eq(JobDto.class))).thenReturn(jobDto1);
    ...
    @Test
    void getRelatedJobs_shouldReturnEmpty_whenNoApplications() {
        when(jobApplicationRepository.findByJobId(10L)).thenReturn(List.of());
    ...
    void getRelatedJobs_shouldReturnRelatedJobs_basedOnCommonApplicants() {
        ...
        when(jobApplicationRepository.findByJobId(10L)).thenReturn(List.of(app1));
        when(jobApplicationRepository.findByUserId(1L)).thenReturn(List.of(app1, app2));
        when(jobRepository.findById(12L)).thenReturn(Optional.of(job3));
