...
class RefreshTokenServiceTest {
    ...
    void rotateRefreshToken_shouldReturnNewToken_whenValid() {
        ...
        when(refreshTokenRepository.save(any(RefreshToken.class)))
                .thenReturn(validToken)   // save old as used
                .thenReturn(newToken);    // save new token
    ...
    void rotateRefreshToken_shouldThrow_whenTokenAlreadyUsed() {
        ...
        // Actual message: "Token reuse detected. All sessions invalidated."
    ...
    void rotateRefreshToken_shouldThrow_whenTokenExpired() {
        ...
        // Actual message: "Refresh token expired. Please login again."
    ...
    void rotateRefreshToken_shouldThrow_whenTokenNotFound() {
        ...
        // Actual message: "Invalid refresh token"
